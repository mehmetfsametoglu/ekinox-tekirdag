    ...
    <>
      ...
      <header className="hero">
        <div className="wrap hero-grid">
          ...
          <div className="hero-visual">
            ...
            <Image src="/images/hero-aerial.jpg" alt="Tekirdağ projesi kuşbakışı görünüm" fill style={{ objectFit: "cover" }} priority />
            <div className="img-caption">Konsept görsel — temsilîdir</div>
          </div>
        </div>
      ...
      <section className="block warm" id="model">
        <div className="wrap">
          ...
          <div className="cols">
            <div className="card">
              <div className="cardimg"><Image src="/images/living-bedroom.jpg" alt="Bağımsız 1+1 daire iç görünüm" width={600} height={375} /></div>
            ...
            <div className="card">
              <div className="cardimg"><Image src="/images/support-bathroom.jpg" alt="Erişilebilir, güvenli banyo tasarımı" width={600} height={375} /></div>
            ...
            <div className="card">
              <div className="cardimg"><Image src="/images/social-garden.jpg" alt="Ortak bahçe ve sosyal yaşam alanı" width={600} height={375} /></div>
      ...
      {/* AKILLI YAŞAM SİSTEMİ */}
      <section className="block">
        <div className="narrow">
          <span className="smart-badge"><span className="pulse"></span> Yapay Zeka Destekli Güvenlik</span>
          <h2 className="sec">Kamera kullanmadan, mahremiyeti koruyan akıllı güvenlik.</h2>
          <p className="lead">Daire içinde gösterişli cihaz kalabalığı yerine, günlük yaşamı bozmayan akıllı sensörler. Yapay zeka destekli sistem; bir şey ters gittiğinde — düşme, hareketsizlik, su kaçağı, duman — merkezi destek ekibine sessizce haber verir. Sizi izlemez, size göz kulak olur.</p>
          <div className="smart-wrap">
            <div>
              <div className="smart-feats">
                <div className="smart-feat">
                  <div className="sicon"><svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="9"/><path d="M12 8v4l2.5 2.5"/></svg></div>
                  <span>Acil çağrı / panik butonu</span>
                </div>
                <div className="smart-feat">
                  <div className="sicon"><svg viewBox="0 0 24 24"><path d="M12 3s5 4 5 9a5 5 0 01-10 0c0-2 1-3 1-3s1 2 2 2c0-3 2-5 2-8z"/></svg></div>
                  <span>Duman ve su kaçağı algılama</span>
                </div>
                <div className="smart-feat">
                  <div className="sicon"><svg viewBox="0 0 24 24"><rect x="4" y="3" width="11" height="18" rx="1"/><circle cx="12" cy="12" r="1"/></svg></div>
                  <span>Kapı ve hareket sensörleri</span>
                </div>
                <div className="smart-feat">
                  <div className="sicon"><svg viewBox="0 0 24 24"><path d="M12 3v2M5 12H3M21 12h-2M6 6L4.5 4.5M18 6l1.5-1.5"/><circle cx="12" cy="13" r="4"/></svg></div>
                  <span>Gece yönlendirme aydınlatması</span>
                </div>
                <div className="smart-feat">
                  <div className="sicon"><svg viewBox="0 0 24 24"><path d="M3 12a9 9 0 0118 0"/><path d="M7 12a5 5 0 0110 0"/><circle cx="12" cy="12" r="1.3"/></svg></div>
                  <span>Mahremiyet odaklı radar sensörü</span>
                </div>
                <div className="smart-feat">
                  <div className="sicon"><svg viewBox="0 0 24 24"><path d="M12 3l8 4v5c0 5-4 8-8 9-4-1-8-4-8-9V7z"/><path d="M9 12l2 2 4-4"/></svg></div>
                  <span>Merkezi destek ekibine uyarı</span>
                </div>
              </div>
              <p className="smart-note"><span className="lock">🔒</span> Sistem kamera görüntüsü kaydetmez. Radar ve sensör verisiyle çalışır; amacı gözetlemek değil, ihtiyaç anında yanınızda olmaktır.</p>
            </div>
            <div className="smart-visual">
              <Image src="/images/interior-living.jpg" alt="Akıllı yaşam paneli, acil çağrı butonu ve sensörler bulunan 1+1 salon konsepti" fill style={{ objectFit: "cover" }} />
              <div className="img-caption">Akıllı yaşam sistemi — temsilîdir</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="block">
        <div className="narrow">
          ...
          <div className="loc-visual">
            <Image src="/images/location-aerial.jpg" alt="Tekirdağ proje konumu, Sincap Evleri bitişiği" fill style={{ objectFit: "cover" }} />
            <div className="img-caption">Konsept görsel — temsilîdir</div>
          </div>
        </div>
      </section>
